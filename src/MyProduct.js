...
import { Card, CardGroup, Button, Row, Col, Spinner, CardColumns, CardDeck } from 'react-bootstrap';
...
export default function MyProduct() {
    ...
    ProductList =
        SearchParam == null ?
            ...
            :
            SearchParam <= 10 ? //means clicked on first level menu items
    ...
    return (
        <div>
            {ds.items.length == 0 ?
                ...
                :
                <div className="card-columns" style={{ textAlign: "center", padding: "15px", backgroundColor: "antiquewhite" }}>
                    {ProductList}
                </div>}
        </div>
    );
